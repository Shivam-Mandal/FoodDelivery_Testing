...
const AboutUs = () => {
  const { isDarkMode } = useContext(FoodContext);
  ...
  return (
    <div className={`${isDarkMode ? 'text-white bg-gray-900' : 'text-gray-800 bg-white'} container mx-auto px-4 sm:px-6 lg:px-8 py-12`}>
      <div className="text-center mb-12">
        <h1 className={`${isDarkMode ? 'text-white' : 'text-gray-900'} text-4xl font-bold`}>About Us</h1>
        <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mt-4 text-lg`}>
          Welcome to FlavorFeet, your premier destination for delicious food delivered right to your doorstep.
        </p>
      </div>
      <div className="space-y-12">
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>Our Story</h2>
          <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4`}>
        ...
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>What We Offer</h2>
          <ul className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4 space-y-4`}>
            <li>
        ...
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>Our Values</h2>
          <ul className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4 space-y-4`}>
            <li>
        ...
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>Join the FlavorFeet Family</h2>
          <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4`}>
        ...
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>Contact Us</h2>
          <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4`}>
        ...
        <section>
          <h2 className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-2xl font-semibold`}>Follow Us</h2>
          <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-700'} mt-4`}>
            Stay connected and get the latest updates by following us on social media:
          </p>
          <ul className="mt-4 flex space-x-6">
            <li>
              <Link to="https://www.facebook.com/FlavorFeet" aria-label="Facebook" className="text-blue-500 hover:text-blue-700">
                <FaFacebookF size={24} />
              </Link>
            </li>
            <li>
              <Link to="https://www.instagram.com/FlavorFeet" aria-label="Instagram" className="text-pink-500 hover:text-pink-700">
                <FaInstagram size={24} />
              </Link>
            </li>
            <li>
              <Link to="https://www.twitter.com/FlavorFeet" aria-label="Twitter" className="text-blue-400 hover:text-blue-600">
                <FaTwitter size={24} />
              </Link>
            </li>
          </ul>
